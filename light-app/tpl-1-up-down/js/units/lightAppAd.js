...
define(function(require, exports, module){
	...
	LightAppAd.prototype._init = function (e) {
		var theClass = this;		var lighturl = document.getElementById("lighturl");		var lightphone = document.getElementById("lightphone");		if(lighturl.value=="" || lightphone.value==""){	return;	}
		if($('.m-lightAppAd').length <= 0){
			//广告
			theClass.$lightAppAd = $('<div class="m-lightAppAd">'+
										'<a href=#  class="m-lightAppAd-link-guide"></a>'+
										'<div class="m-lightAppAd-body">'+
											'<div class="m-lightAppAd-title"></div>'+
											'<a href='+lighturl.value+'  class="m-lightAppAd-link-get"></a>'+
 											'<a href=tel:'+lightphone.value+'  class="m-lightAppAd-link-tel"></a>'+
										'</div>'+
									'</div>');
			//将广告放到最后一页
