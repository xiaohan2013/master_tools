;$(function() {
	...
	(function() {
		var html = [
				...
				'<img data="iwz" class="clii"  style="left: 18px;" src="http://style.mc2113.com/dist/lib/mc_ui/images/iwz.png">',
				'<img data="ixz" class="clii" style="left: 120px;" src="http://style.mc2113.com/dist/lib/mc_ui/images/ixz.png">',
				'<img data="ibf" class="clii" style="right: 10px;" src="http://style.mc2113.com/dist/lib/mc_ui/images/ibf.png">',
				'<a data="wz">试试手气</a>',
				'<a data="xz" style="left: 122px;">试试手气</a>',
				'<a data="bf" style="left: 216px;">试试手气</a>',
				'<img id="shuts" src="http://style.mc2113.com/dist/lib/mc_ui/images/shuts.png" />',
				'<h1 style="top:48px;display:none;" class="d-l-w">您还有<span class="remain-times">13</span>颗大力丸</h1>',

				'<h1 class="lw-title" style="font-size: 25px;">快点选个礼盒打开吧！</h1>',
				...
				'<h1 style="font-size: 23px;">恭喜您</h1>',

				'<h2 style="top:270px;">获得<span class="avatarName">一等奖</span></h2>',
				'<a class="btn-go" style="left: 50%;margin-left: -118px;">马上领奖</a>',
				'<a style="left: 53.125%;" class="btn-again">再来一次</a>',
				'</div>',
				'<div class="lottery-unluck" style="display: none;">',
				'<h1 style="font-size: 23px;">oh，真遗憾</h1>',
				'<h2 style="top:270px;">谢谢参与</h2>',
				'<a class="btn-close" style="left: 50%;margin-left: -118px;">关闭</a>',
				'<a style="left: 53.125%;" class="btn-again">再来一次</a>',
				'</div>',
				'</div>',
				'</div>',
	...
	function get_luck(index, attr) {
		MCUI.API.getLuck(index, attr, function(data) {
			...
			if (data.code == '200') {
				...
				$(".get-box img").attr(
						"src",
						"http://style.mc2113.com/dist/lib/mc_ui/images/" + attr
								+ ".png");
	...
	$(function() {
		...
		$(".get-box .btn-go")
				.on(
						"click",
						function() {
							window.location.href = '/plugin/ushare/award_user_info_form.htm?gameId='
									+ mc.info.gameId + '&id=' + mc.user.luckId;
						});
