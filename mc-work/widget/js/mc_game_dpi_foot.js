...
(function() {
	var html = [
		...
		'<a class="btn-bottom btn-rule"><span style="margin-left: -13px;">活动详情</span></a>',
		'<a class="btn-bottom btn-rank"><span style="margin-left: -10px;">排&nbsp;行&nbsp;榜</span></a>',
		'<a class="btn-bottom btn-start" style="background-image: none;"></a>',
		'<a class="btn-bottom btn-prize"><span style="margin-left: -13px;">奖品抢兑</span></a>',
		'<a class="btn-bottom btn-share"><span style="margin-left: -9px;">立即分享</span></a>',
		'</div>',
...
(function($, window, document, undefined) {
	...
	MCUI.gameMask = {};
	MCUI.Util = MCUI.Util || {};
	MCUI.Util.toUrl = function(baseurl, id) {
		if (mc.refUrl.award) {
	...
	MCUI.gameMask.show = function() {
		$("#foot_mask").show();
	}
	MCUI.gameMask.hide = function() {
		$('#foot_mask').hide();
	}
	...
	$('#foot_mask').click(function() {
		window.MCUI.gameMask.hide()
	});
	$('#foot_limit_share_mask').click(function() {
		MCUI.gameMask.hideLimitShare()
	});
	window.MCUI.gameFoot.changeFoot && window.MCUI.gameFoot.changeFoot()
